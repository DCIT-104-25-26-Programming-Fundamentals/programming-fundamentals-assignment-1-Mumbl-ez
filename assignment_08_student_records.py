...
def add_student(students):
    """
    Prompts the user for student details (name, ID, scores) and adds a new
    dictionary record to the students list.
    """
...
def display_all_students(students):
    """
    Prints a formatted table displaying all students, their IDs, scores, and averages.
    """
    if not students:
    ...
    for s in students:
        ...
        print(f"{s['name']:<20} {s['id']:<12} {scores_str:<18} {avg_score:<8.2f}")
...
def calculate_student_average(students):
    ...
    try:
        ...
        print("Error: Invalid ID. Please enter a numerical ID.")
        return
